...
class GPSurrogateModel:
    ...
    def fit_gp(self):
        ...
        #matern = ConstantKernel(1.0)*Matern(length_scale=1.0)
        rbf = RBF(length_scale = 1.0)
        gpr1 = GaussianProcessRegressor(kernel=rbf, alpha = 1e-5, n_restarts_optimizer = 20, random_state = 88)
        gpr2 = GaussianProcessRegressor(kernel=rbf, alpha = 1e-5, n_restarts_optimizer = 20, random_state = 88)
